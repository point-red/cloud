        ...
        <p-block-inner :is-loading="loading">
          ...
          <p-table>
            ...
            <tr slot="p-body" v-for="(indicator, indicatorIndex) in form.salary.assessments" :key="'indicator' + indicator.id">
              ...
              <td>{{ additionalData.score_percentages_assessments[indicator.name].week1 | numberFormat }}%</td>
              <td>{{ additionalData.score_percentages_assessments[indicator.name].week2 | numberFormat }}%</td>
              <td>{{ additionalData.score_percentages_assessments[indicator.name].week3 | numberFormat }}%</td>
              <td>{{ additionalData.score_percentages_assessments[indicator.name].week4 | numberFormat }}%</td>
              <td>{{ additionalData.score_percentages_assessments[indicator.name].week5 | numberFormat }}%</td>
              <td>
                <p-form-input
                  id="indicator-weight"
  ...
  methods: {
    ...
    salaryAssessmentWeight () {
      ...
      this.form.salary.assessments.forEach((indicator, key) => {
        this.additionalData.total_assessments.weight += Number(indicator.weight)
        for (const key in this.additionalData.score_percentages_assessments[indicator.name]) {
          this.additionalData.total_assessments[key] += Number(indicator.weight) * this.additionalData.score_percentages_assessments[indicator.name][key] / 100
        }
      })
    ...
    salaryAchievementWeight () {
      ...
      this.form.salary.achievements.forEach((achievement, key) => {
        this.additionalData.total_achievements.weight += Number(achievement.weight)
        this.additionalData.total_achievements.week1 += Number(achievement.week1) * Number(achievement.weight) / 100
        this.additionalData.total_achievements.week2 += Number(achievement.week2) * Number(achievement.weight) / 100
        this.additionalData.total_achievements.week3 += Number(achievement.week3) * Number(achievement.weight) / 100
        this.additionalData.total_achievements.week4 += Number(achievement.week4) * Number(achievement.weight) / 100
        this.additionalData.total_achievements.week5 += Number(achievement.week5) * Number(achievement.weight) / 100
      })
    ...
    calculate () {
      ...
      this.salary_final_score.week4 = (this.additionalData.total_assessments.week4 + this.additionalData.total_achievements.week4) / 2
      this.salary_final_score.week5 = (this.additionalData.total_assessments.week5 + this.additionalData.total_achievements.week5) / 2

      if (this.form.salary.active_days_in_month != null && Number(this.form.salary.active_days_in_month != 0)) {
        let baseSalaryPerWeek = this.form.salary.base_salary / Number(this.form.salary.active_days_in_month)

        this.base_salary_week_1 = baseSalaryPerWeek * Number(this.form.salary.active_days_week1)
        this.base_salary_week_2 = baseSalaryPerWeek * Number(this.form.salary.active_days_week2)
      ...
      this.real_transport_allowance_week_2 = this.form.salary.daily_transport_allowance * Number(this.form.salary.active_days_week2)
      this.real_transport_allowance_week_3 = this.form.salary.daily_transport_allowance * Number(this.form.salary.active_days_week3)
      this.real_transport_allowance_week_4 = this.form.salary.daily_transport_allowance * Number(this.form.salary.active_days_week4)
      this.real_transport_allowance_week_5 = this.form.salary.daily_transport_allowance * Number(this.form.salary.active_days_week5)

      this.minimum_component_amount_week_1 = Number(Number(this.additionalData.total_assessments.week1) * Number(this.base_salary_week_1)) / 100
      this.minimum_component_amount_week_2 = Number(Number(this.additionalData.total_assessments.week2) * Number(this.base_salary_week_2)) / 100
      this.minimum_component_amount_week_3 = Number(Number(this.additionalData.total_assessments.week3) * Number(this.base_salary_week_3)) / 100
      this.minimum_component_amount_week_4 = Number(Number(this.additionalData.total_assessments.week4) * Number(this.base_salary_week_4)) / 100
      this.minimum_component_amount_week_5 = Number(Number(this.additionalData.total_assessments.week5) * Number(this.base_salary_week_5)) / 100

      this.multiplier_kpi_week_1 = Number(this.form.salary.multiplier_kpi * Number(this.form.salary.active_days_week1)) / Number(this.form.salary.active_days_in_month)
      this.multiplier_kpi_week_2 = Number(this.form.salary.multiplier_kpi * Number(this.form.salary.active_days_week2)) / Number(this.form.salary.active_days_in_month)
      this.multiplier_kpi_week_3 = Number(this.form.salary.multiplier_kpi * Number(this.form.salary.active_days_week3)) / Number(this.form.salary.active_days_in_month)
      this.multiplier_kpi_week_4 = Number(this.form.salary.multiplier_kpi * Number(this.form.salary.active_days_week4)) / Number(this.form.salary.active_days_in_month)
      this.multiplier_kpi_week_5 = Number(this.form.salary.multiplier_kpi * Number(this.form.salary.active_days_week5)) / Number(this.form.salary.active_days_in_month)

      this.additional_component_point_week_1 = Number(Number(this.additionalData.total_achievements.week1) * Number(this.multiplier_kpi_week_1)) / 100
      this.additional_component_point_week_2 = Number(Number(this.additionalData.total_achievements.week2) * Number(this.multiplier_kpi_week_2)) / 100
      this.additional_component_point_week_3 = Number(Number(this.additionalData.total_achievements.week3) * Number(this.multiplier_kpi_week_3)) / 100
      this.additional_component_point_week_4 = Number(Number(this.additionalData.total_achievements.week4) * Number(this.multiplier_kpi_week_4)) / 100
      this.additional_component_point_week_5 = Number(Number(this.additionalData.total_achievements.week5) * Number(this.multiplier_kpi_week_5)) / 100
      ...
      this.total_amount_received_week_1 = this.total_amount_week_1 - this.form.salary.receiveable_cut_60_days_week1
      this.total_amount_received_week_2 = this.total_amount_week_2 - this.form.salary.receiveable_cut_60_days_week2
      this.total_amount_received_week_3 = this.total_amount_week_3 - this.form.salary.receiveable_cut_60_days_week3
      this.total_amount_received_week_4 = this.total_amount_week_4 - this.form.salary.receiveable_cut_60_days_week4
      this.total_amount_received_week_5 = this.total_amount_week_5 - this.form.salary.receiveable_cut_60_days_week5

      this.total_amount_received = this.total_amount_received_week_1 + this.total_amount_received_week_2 + this.total_amount_received_week_3 + this.total_amount_received_week_4 + this.total_amount_received_week_5 + this.form.salary.communication_allowance + this.form.salary.team_leader_allowance

      this.company_profit_week_1 = (5 / 100) * (Number(this.form.salary.payment_from_marketing_week1) + Number(this.form.salary.payment_from_sales_week1) + Number(this.form.salary.payment_from_spg_week1))
      this.company_profit_week_2 = (5 / 100) * (Number(this.form.salary.payment_from_marketing_week2) + Number(this.form.salary.payment_from_sales_week2) + Number(this.form.salary.payment_from_spg_week2))
      this.company_profit_week_3 = (5 / 100) * (Number(this.form.salary.payment_from_marketing_week3) + Number(this.form.salary.payment_from_sales_week3) + Number(this.form.salary.payment_from_spg_week3))
      this.company_profit_week_4 = (5 / 100) * (Number(this.form.salary.payment_from_marketing_week4) + Number(this.form.salary.payment_from_sales_week4) + Number(this.form.salary.payment_from_spg_week4))
      this.company_profit_week_5 = (5 / 100) * (Number(this.form.salary.payment_from_marketing_week5) + Number(this.form.salary.payment_from_sales_week5) + Number(this.form.salary.payment_from_spg_week5))

      this.settlement_difference_minus_amount_week_1 = Number(this.form.salary.payment_from_marketing_week1) + Number(this.form.salary.payment_from_sales_week1) + Number(this.form.salary.payment_from_spg_week1) - Number(this.total_amount_received_week_1)
      this.settlement_difference_minus_amount_week_2 = Number(this.form.salary.payment_from_marketing_week2) + Number(this.form.salary.payment_from_sales_week2) + Number(this.form.salary.payment_from_spg_week2) - Number(this.total_amount_received_week_2)
      this.settlement_difference_minus_amount_week_3 = Number(this.form.salary.payment_from_marketing_week3) + Number(this.form.salary.payment_from_sales_week3) + Number(this.form.salary.payment_from_spg_week3) - Number(this.total_amount_received_week_3)
      this.settlement_difference_minus_amount_week_4 = Number(this.form.salary.payment_from_marketing_week4) + Number(this.form.salary.payment_from_sales_week4) + Number(this.form.salary.payment_from_spg_week4) - Number(this.total_amount_received_week_4)
      this.settlement_difference_minus_amount_week_5 = Number(this.form.salary.payment_from_marketing_week5) + Number(this.form.salary.payment_from_sales_week5) + Number(this.form.salary.payment_from_spg_week5) - Number(this.total_amount_received_week_5)

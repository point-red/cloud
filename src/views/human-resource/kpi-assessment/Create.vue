        ...
        <p-block-inner :is-loading="isLoading">
          ...
          <p-table>
            ...
            >
              <tr :key="'group' + group.id" class="bg-info-light">
                <td class="text-center font-w600" colspan="2">
                  {{ group.name }}
                </td>
          ...
          <div class="form-group row">
            <div class="col-md-12">
              ...
              >
                <i v-show="isSubmit" class="fa fa-asterisk fa-spin" />
                {{ $t("save") | uppercase }}
              </button>
              <button
                type="button"
...
export default {
  ...
  methods: {
    ...
    onSave(indicator_id = null, files = null) {
      this.isSaving = true;
      if (this.kpiId != null) {
          ...
          .then(
            (response) => {
              if (indicator_id !== null && files !== null) {
                ...
                formData.append("feature_id", indicator_id);
        ...
        this.form.date.start = this.serverDateTime(
    ...
    assignSelected() {
      ...
      this.isSaving = false;
      console.log(this.dataAttachmentId);
    },
    getAutomatedScore() {
      var automatedIDs = [];

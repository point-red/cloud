...
export default [
  ...
  { path: '/human-resource/job-value/assessment/show/:id', name: 'JobValueAssessmentShow', component: Show },
  { path: '/human-resource/job-value/assessment/show/:id/calculation', name: 'JobValueAssessmentCalculation', component: Calculation },

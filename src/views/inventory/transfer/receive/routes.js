...
import InventoryTransferReceiveHistories from '@/views/inventory/transfer/receive/Histories'
...
export default [
  ...
  { path: '/inventory/transfer/receive/:id/histories', name: 'inventory.transfer.receive.histories', component: InventoryTransferReceiveHistories }
]

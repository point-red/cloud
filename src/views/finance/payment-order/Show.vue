  ...
  <div>
    ...
    <div class="alert alert-danger d-flex align-items-center justify-content-between mb-15"
      ...
      <div class="flex-fill mr-10">
        ...
        <div style="white-space: pre-wrap;"><b>{{ $t('reason') | uppercase }}:</b> <pre>{{ paymentOrder.form.approval_reason }}</pre></div>
      </div>
    </div>
    ...
    <div class="alert alert-danger d-flex align-items-center justify-content-between mb-15"
      ...
      <div class="flex-fill mr-10">
        ...
        <div style="white-space: pre-wrap;"><b>{{ $t('reason') | uppercase }}:</b> <pre>{{ paymentOrder.form.cancellation_approval_reason }}</pre></div>
      </div>
    </div>
    ...
    <div class="alert alert-danger d-flex align-items-center justify-content-between mb-15"
      ...
      <div class="flex-fill mr-10">
        ...
        <div style="white-space: pre-wrap;"><b>{{ $t('reason') | uppercase }}:</b> <pre>{{ paymentOrder.form.request_cancellation_reason }}</pre></div>
      </div>
    </div>
        ...
        <p-block-inner :is-loading="isLoading">
          ...
          <div class="row mt-50">
            ...
            <div class="col-sm-3 text-center">
              ...
              <div class="mb-50" style="font-size:11px">{{ paymentOrder.form.date | dateFormat('DD MMMM YYYY') }}</div>

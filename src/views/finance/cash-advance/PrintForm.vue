<template>
  <sweet-modal
    ref="print-form"
    :title="$t('print cash advance') | uppercase"
    overlay-theme="dark"
    @close="onClose()"
  >
    <table
        ...
        <tr>
          <td>
            ...
            >
              ...
              <tr
                v-for="(row, index) in cash.details"
                :key="index"
              >
                <td>{{ index+1 }}</td>
            ...
            <span>Notes: {{ cash.form.notes }}</span>
            <div
            ...
            >
              ...
              >
                <h3>Created by</h3>
                <br><br><br>
                {{ cash.form.created_by.full_name }}
              </div>
              <div class="text-center">
                <h3>Approved by</h3>
                <br><br><br>
                {{ cash.form.request_approval_to.full_name }}
              </div>
            </div>
          </td>
        </tr>

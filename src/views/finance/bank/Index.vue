          ...
          <div class="input-group block">
            ...
            >
              <span class="input-group-text">
                <i class="fa fa-plus mr-5" /> {{ $t('bank in') | uppercase }}
              </span>
            </router-link>
            <router-link
              v-if="$permission.has('create bank')"
            ...
            >
              <span class="input-group-text">
                <i class="fa fa-plus mr-5" /> {{ $t('bank out') | uppercase }}
              </span>
            </router-link>
            <p-form-input
              id="search-text"
                ...
                >
                  <th>
                    <router-link
                      ...
                      :to="{ name: 'finance.bank.in.show', params: { id: payment.id }}"
                    >
                      {{ payment.form.number }}
                    </router-link>
                    <router-link
                      v-if="payment.disbursed == true"
                      :to="{ name: 'finance.bank.out.show', params: { id: payment.id }}"
                    >
                      {{ payment.form.number }}
                    </router-link>
                  </th>

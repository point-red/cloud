<template>
  <div>
      ...
      >
        ...
        >
          ...
          >
            ...
            >{{ filterName || $t('select') | uppercase }}</span>
          </div>
        </p-form-row>
        <p-form-row
          id="branch"
    ...
    />
    <m-filter-sales-accumulation
      ref="filter"
      @choosen="chooseFilter"
    />
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapGetters('pluginPinPointReportAccumulation', ['reasons', 'totalPerWeek','sales'])
  },
  methods: {
    ...mapActions('pluginPinPointReportAccumulation', ['get']),
    chooseBranch (option) {

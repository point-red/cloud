                ...
                <template v-if="indexWeek == 0">
                  <template v-for="(product, indexReason) in products">
                    ...
                    >
                      ...
                      <td class="text-right">
                        {{ product.week1 / totalPerWeek[0] * 100 | numberFormat }}%
                      </td>
                      <td class="text-right">
                        {{ product.week2 }}
                      </td>
                      <td class="text-right">
                        {{ product.week2 / totalPerWeek[1] * 100 | numberFormat }}%
                      </td>
                      <td class="text-right">
                        {{ product.week3 }}
                      </td>
                      <td class="text-right">
                        {{ product.week3 / totalPerWeek[2] * 100 | numberFormat }}%
                      </td>
                      <td class="text-right">
                        {{ product.week4 }}
                      </td>
                      <td class="text-right">
                        {{ product.week4 / totalPerWeek[3] * 100 | numberFormat }}%
                      </td>
                      <td
                      ...
                      <td
                        ...
                        class="text-right"
                      >
                        {{ product.week5 / totalPerWeek[4] * 100 | numberFormat }}%
                      </td>
                    </tr>
                  </template>
                </template>

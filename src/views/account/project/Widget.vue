<template>
  <div class="row gutters-tiny">
    <div class="col-md-6 col-xl-3">
      <router-link
        :to="'/account/project/' + project.id + '/database'"
    ...
    <div class="col-md-6 col-xl-3">
      <router-link
        :to="'/account/project/' + project.id + '/plugins'"
        class="block block-link-shadow text-right">
        <div class="block-content block-content-full clearfix">
          <div class="float-left mt-10 d-none d-sm-block">
            <i class="fa fa-list-alt fa-3x text-body-bg-dark"></i>
          ...
          <div class="font-size-sm font-w600 text-uppercase text-muted">Package & Plugins</div>
        </div>
      </router-link>
    </div>
  </div>

...
import ManufactureInputEdit from '@/views/manufacture/process-io/input/Edit'
...
export default [
  ...
  { path: '/manufacture/process-io/:id/input/:inputId/edit', name: 'manufacture.process.io.input.edit', component: ManufactureInputEdit }
]

<template>
  <div>
    <p-modal :ref="'select-' + id" :id="'select-' + id" title="create sales down payment">
          ...
          <p-block>
            <p-form-row
              ...
              <div slot="body" class="col-lg-9 mt-5">
                <m-customer id="customer" v-model="form.customer_id"/>
              </div>
            </p-form-row>
            ...
            <p-form-row
              ...
              <div slot="body" class="col-lg-9 mt-5">
                <m-chart-of-account id="chart-of-account" v-model="form.chart_of_account_id" sub-ledger="sales down payment"/>
              </div>
            </p-form-row>
...
export default {
  ...
  methods: {
    ...mapActions('accountingCutOffSalesDownPayment', ['create']),
    onSubmit () {
      this.isSaving = true

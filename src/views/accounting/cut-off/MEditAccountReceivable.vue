...
export default {
  ...
  methods: {
    ...mapActions('accountingCutOffAccountReceivable', ['update', 'delete']),
    onSubmit () {
      this.isSaving = true
    ...
    show (cutOffAccountReceivable) {
      this.form.id = cutOffAccountReceivable.id
      this.form.customer_id = cutOffAccountReceivable.customer_id
      this.form.amount = cutOffAccountReceivable.amount
      this.form.chart_of_account_id = cutOffAccountReceivable.chart_of_account_id
      this.form.chart_of_account_name = cutOffAccountReceivable.account.name
      this.form.notes = cutOffAccountReceivable.notes
      this.form.customer_name = cutOffAccountReceivable.customer.name

<template>
  <div>
    <breadcrumb v-if="purchaseInvoice">
      <breadcrumb-purchase/>
      <router-link to="/purchase/invoice" class="breadcrumb-item">{{ $t('purchase invoice') | uppercase }}</router-link>
    ...
    <div class="row" v-if="purchaseInvoice">
      <p-block>
        <p-block-inner :is-loading="isLoading">
          <div class="row">
            <div class="col-sm-12">
              <div class="text-right">
                <router-link :to="{ name: 'purchase.invoice.create' }" class="btn btn-sm btn-outline-secondary mr-5">
                  {{ $t('create') | uppercase }}
                </router-link>
          ...
          <point-table class="mt-20">
            ...
            <tr slot="p-body">
              ...
              <td class="text-right"><b>{{ purchaseInvoice.subtotal | numberFormat }}</b></td>
              <td></td>
            </tr>
            <tr slot="p-body">
              <th></th>
              ...
              <td class="text-right"><b>{{ purchaseInvoice.discount_value | numberFormat }}</b></td>
              <td></td>
            </tr>
            <tr slot="p-body">
              <th></th>
              ...
              <td class="text-right"><b>{{ purchaseInvoice.amount - purchaseInvoice.tax | numberFormat }}</b></td>
              <td></td>
            </tr>
            <tr slot="p-body">
              <th></th>
              ...
              <td class="text-right"><b>{{ purchaseInvoice.tax | numberFormat }}</b></td>
              <td></td>
            </tr>
            <tr slot="p-body">
              <th></th>
              ...
              <td class="text-right"><b>{{ purchaseInvoice.amount | numberFormat }}</b></td>
              <td></td>
            </tr>
          </point-table>
          <div class="row mt-50">
            <div class="col-sm-6">
              ...
              <div style="white-space: pre-wrap;">{{ purchaseInvoice.form.notes }}</div>
              <div class="d-sm-block d-md-none mt-10"></div>
            </div>
            <div class="col-sm-3 text-center">
              <h6 class="mb-0">{{ $t('requested by') | uppercase }}</h6>
              <div class="mb-50" style="font-size:11px">{{ purchaseInvoice.form.date | dateFormat('DD MMMM YYYY') }}</div>
            ...
            <div class="col-sm-3 text-center">
              ...
              <div style="font-size:11px">{{ purchaseInvoice.form.request_approval_to.email | lowercase }}</div>
            </div>
          </div>
        </p-block-inner>
      </p-block>
...
export default {
  ...
  methods: {
    ...
    toggleMore () {
      let isMoreActive = this.purchaseInvoice.items.some(function (el, index) {

          ...
          <point-table>
            ...
            <template v-for="(purchaseInvoice, index) in purchaseInvoices">
              ...
              >
                ...
                <td class="text-right">
                  {{ purchaseInvoiceItem.quantity | numberFormat }} {{ purchaseInvoiceItem.unit }}
                </td>
                <td class="text-right">
                  {{ purchaseInvoiceItem.price | numberFormat }}
                </td>
                <td class="text-right">
                  {{ (purchaseInvoiceItem.quantity * purchaseInvoiceItem.price) | numberFormat }}
                </td>
                <td class="text-center">
                  <div
                    v-if="purchaseInvoice.form.approval_status == 0"
                    class="badge badge-primary"
                  >
                    {{ $t('pending') | uppercase }}
                  </div>
                  <div
                    v-if="purchaseInvoice.form.approval_status == -1"
                ...
                <td class="text-center">
                  <div
                    v-if="purchaseInvoice.form.cancellation_status == 1"
                    class="badge badge-danger"
                  >
                    {{ $t('canceled') | uppercase }}
                  </div>
                  <div
                    v-else-if="purchaseInvoice.form.done == 0"
                    class="badge badge-primary"
                  >
                    {{ $t('pending') | uppercase }}
                  </div>
                  <div
                    v-else-if="purchaseInvoice.form.done == 1"
                    class="badge badge-success"
                  >
                    {{ $t('done') | uppercase }}
                  </div>

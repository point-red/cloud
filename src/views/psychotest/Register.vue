  ...
  methods: {
    ...
    async onSubmit () {
      try {
        ...
        const { data: candidate } = await this.createCandidate(this.form)
        ...
        this.$notification.success('User Registration Success')
        ...
        this.loadingSaveButton = false
        this.$notification.error('User Registration Failed', error.message)

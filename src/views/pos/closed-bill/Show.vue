<template>
  <div>
    <breadcrumb>
      <breadcrumb-pos/>
      <router-link to="/pos/closed-bill" class="breadcrumb-item">{{ $t('closed bill') | titlecase }}</router-link>
    ...
    <p-block
      ...
      <template v-slot:header>
        ...
        |<router-link
          v-if="$permission.has('read pos closed bill')"
          to="/pos/closed-bill"
          exact>
          <button
            type="button"
